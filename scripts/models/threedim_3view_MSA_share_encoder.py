...
class Encoder2d(nn.Module):
    def __init__(self, in_channels=1, residual='conv'):
        ...
        # self.down_conv_bk1 = Conv3D_Block(32, feats[0], residual=residual)
...
class Threedim_3view_CNN(nn.Module):

    def __init__(self, in_channels=1):
        '''
        in_channels: 1
        '''
        super(Threedim_3view_CNN, self).__init__()
    ...
    def forward(self, x_3d, x1, x2, x3):
